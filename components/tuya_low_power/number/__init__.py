...
from .. import CONF_TUYA_LOW_POWER_ID, TuyaLowPower, TuyaDatapointType, tuya_low_power_ns
...
TuyaLPNumber = tuya_low_power_ns.class_("TuyaLPNumber", number.Number, cg.Component)
...
CONFIG_SCHEMA = cv.All(
    number.number_schema(TuyaLPNumber)
    .extend(
        {
